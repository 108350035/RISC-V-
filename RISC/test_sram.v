...
//      version:		2003Q2V1
//      comment:		
//      configuration:	 -instname "test_sram" -words 256 -bits 32 -frequency 100 -ring_width 2 -mux 16 -drive 12 -write_mask on -wp_size 8 -top_layer met6 -power_type rings -horiz met3 -vert met4 -cust_comment "" -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND
//
//      Verilog model for Synchronous Dual-Port Ram
//
//      Instance Name:  test_sram
//      Words:          256
//      Word Width:     32
//      Pipeline:       No
//
//      Creation Date:  2025-12-07 14:16:01Z
//      Version: 	2003Q2V1
//
...
module test_sram (
   ...
   reg			   LAST_NOT_CENA;
   reg [mask_width-1:0]	   LAST_NOT_WENA;
   ...
   reg			   LAST_NOT_CENB;
   reg [mask_width-1:0]	   LAST_NOT_WENB;
   ...
   reg [mask_width-1:0]    valid_cycleA;
   reg [mask_width-1:0]    valid_cycleB;
   ...
   begin
    ...
    begin
      ...
      casez({WENAi[mask_section],CENAi})

	2'b10: begin
	   valid_cycleA[mask_section] = 1;
	   read_memA(1,0);
	end
	2'b00: begin
	   valid_cycleA[mask_section] = 0;
	   write_mem(AAi,DAi);
	   read_memA(0,0);
	end
	2'b?1: ;
   ...
   begin
    ...
    begin
      lsb = (mask_section)*(wp_size) ;
      msb = BITS <= (lsb+wp_size-1) ? (BITS-1) : (lsb+wp_size-1) ;
      casez({WENBi[mask_section],CENBi})

	2'b10: begin
	   valid_cycleB[mask_section] = 1;
	   read_memB(1,0);
	end
	2'b00: begin
	   valid_cycleB[mask_section] = 0;
	   write_mem(ABi,DBi);
	   read_memB(0,0);
	end
	2'b?1: ;
   ...
   begin
    ...
    begin
      lsb = (mask_section)*(wp_size) ;
      msb = BITS <= (lsb+wp_size-1) ? (BITS-1) : (lsb+wp_size-1) ;
      casez({valid_cycleB[mask_section],WENAi[mask_section]})
	2'bx?: ;
	2'b00,
	2'b0x:begin
           write_mem_x(AAi);
   ...
   begin
    ...
    begin
      lsb = (mask_section)*(wp_size) ;
      msb = BITS <= (lsb+wp_size-1) ? (BITS-1) : (lsb+wp_size-1) ;
      casez({valid_cycleA[mask_section],WENBi[mask_section]})
	2'bx?: ;
	2'b00,
	2'b0x:begin
	   write_mem_x(ABi);
   ...
   begin
	 ...
	 begin
	    if (valid_address(AAi))
	       begin
                  dummy = mem[AAi] ;
                  for (i=lsb;i<=msb;i=i+1) QAi[i] = dummy[i] ;
	       end
	    else
	       begin
                  for (i=lsb;i<=msb;i=i+1) QAi[i] = 1'bx ;
	       end
	 end
      else
	 begin
   ...
   begin
	 ...
	 begin
	    if (valid_address(ABi))
	       begin
                  dummy = mem[ABi] ;
                  for (i=lsb;i<=msb;i=i+1) QBi[i] = dummy[i] ;
	       end
	    else
	       begin
                  for (i=lsb;i<=msb;i=i+1) QBi[i] = 1'bx ;
	       end
	 end
      else
	 begin
   ...
   assign re_data_flagA0 = !(_CENA || _WENA[0]);
   assign re_data_flagA1 = !(_CENA || _WENA[1]);
   assign re_data_flagA2 = !(_CENA || _WENA[2]);
   assign re_data_flagA3 = !(_CENA || _WENA[3]);
   assign _OENBi = _OENB;
   assign _QB = QBi;
   assign re_flagB = !(_CENB);
   assign re_data_flagB0 = !(_CENB || _WENB[0]);
   assign re_data_flagB1 = !(_CENB || _WENB[1]);
   assign re_data_flagB2 = !(_CENB || _WENB[2]);
   assign re_data_flagB3 = !(_CENB || _WENB[3]);
   ...
   specify
      ...
      $setuphold(posedge CLKA &&& re_flagA, posedge WENA[0], 1.000, 0.500, NOT_WENA0);
      $setuphold(posedge CLKA &&& re_flagA, negedge WENA[0], 1.000, 0.500, NOT_WENA0);
      $setuphold(posedge CLKA &&& re_flagA, posedge WENA[1], 1.000, 0.500, NOT_WENA1);
      $setuphold(posedge CLKA &&& re_flagA, negedge WENA[1], 1.000, 0.500, NOT_WENA1);
      $setuphold(posedge CLKA &&& re_flagA, posedge WENA[2], 1.000, 0.500, NOT_WENA2);
      $setuphold(posedge CLKA &&& re_flagA, negedge WENA[2], 1.000, 0.500, NOT_WENA2);
      $setuphold(posedge CLKA &&& re_flagA, posedge WENA[3], 1.000, 0.500, NOT_WENA3);
      $setuphold(posedge CLKA &&& re_flagA, negedge WENA[3], 1.000, 0.500, NOT_WENA3);
      ...
      $setuphold(posedge CLKA &&& re_data_flagA0, posedge DA[0],1.000, 0.500, NOT_DA0);
      $setuphold(posedge CLKA &&& re_data_flagA0, negedge DA[0],1.000, 0.500, NOT_DA0);
      $setuphold(posedge CLKA &&& re_data_flagA0, posedge DA[1],1.000, 0.500, NOT_DA1);
      $setuphold(posedge CLKA &&& re_data_flagA0, negedge DA[1],1.000, 0.500, NOT_DA1);
      $setuphold(posedge CLKA &&& re_data_flagA0, posedge DA[2],1.000, 0.500, NOT_DA2);
      $setuphold(posedge CLKA &&& re_data_flagA0, negedge DA[2],1.000, 0.500, NOT_DA2);
      $setuphold(posedge CLKA &&& re_data_flagA0, posedge DA[3],1.000, 0.500, NOT_DA3);
      $setuphold(posedge CLKA &&& re_data_flagA0, negedge DA[3],1.000, 0.500, NOT_DA3);
      $setuphold(posedge CLKA &&& re_data_flagA0, posedge DA[4],1.000, 0.500, NOT_DA4);
      $setuphold(posedge CLKA &&& re_data_flagA0, negedge DA[4],1.000, 0.500, NOT_DA4);
      $setuphold(posedge CLKA &&& re_data_flagA0, posedge DA[5],1.000, 0.500, NOT_DA5);
      $setuphold(posedge CLKA &&& re_data_flagA0, negedge DA[5],1.000, 0.500, NOT_DA5);
      $setuphold(posedge CLKA &&& re_data_flagA0, posedge DA[6],1.000, 0.500, NOT_DA6);
      $setuphold(posedge CLKA &&& re_data_flagA0, negedge DA[6],1.000, 0.500, NOT_DA6);
      $setuphold(posedge CLKA &&& re_data_flagA0, posedge DA[7],1.000, 0.500, NOT_DA7);
      $setuphold(posedge CLKA &&& re_data_flagA0, negedge DA[7],1.000, 0.500, NOT_DA7);
      $setuphold(posedge CLKA &&& re_data_flagA1, posedge DA[8],1.000, 0.500, NOT_DA8);
      $setuphold(posedge CLKA &&& re_data_flagA1, negedge DA[8],1.000, 0.500, NOT_DA8);
      $setuphold(posedge CLKA &&& re_data_flagA1, posedge DA[9],1.000, 0.500, NOT_DA9);
      $setuphold(posedge CLKA &&& re_data_flagA1, negedge DA[9],1.000, 0.500, NOT_DA9);
      $setuphold(posedge CLKA &&& re_data_flagA1, posedge DA[10],1.000, 0.500, NOT_DA10);
      $setuphold(posedge CLKA &&& re_data_flagA1, negedge DA[10],1.000, 0.500, NOT_DA10);
      $setuphold(posedge CLKA &&& re_data_flagA1, posedge DA[11],1.000, 0.500, NOT_DA11);
      $setuphold(posedge CLKA &&& re_data_flagA1, negedge DA[11],1.000, 0.500, NOT_DA11);
      $setuphold(posedge CLKA &&& re_data_flagA1, posedge DA[12],1.000, 0.500, NOT_DA12);
      $setuphold(posedge CLKA &&& re_data_flagA1, negedge DA[12],1.000, 0.500, NOT_DA12);
      $setuphold(posedge CLKA &&& re_data_flagA1, posedge DA[13],1.000, 0.500, NOT_DA13);
      $setuphold(posedge CLKA &&& re_data_flagA1, negedge DA[13],1.000, 0.500, NOT_DA13);
      $setuphold(posedge CLKA &&& re_data_flagA1, posedge DA[14],1.000, 0.500, NOT_DA14);
      $setuphold(posedge CLKA &&& re_data_flagA1, negedge DA[14],1.000, 0.500, NOT_DA14);
      $setuphold(posedge CLKA &&& re_data_flagA1, posedge DA[15],1.000, 0.500, NOT_DA15);
      $setuphold(posedge CLKA &&& re_data_flagA1, negedge DA[15],1.000, 0.500, NOT_DA15);
      $setuphold(posedge CLKA &&& re_data_flagA2, posedge DA[16],1.000, 0.500, NOT_DA16);
      $setuphold(posedge CLKA &&& re_data_flagA2, negedge DA[16],1.000, 0.500, NOT_DA16);
      $setuphold(posedge CLKA &&& re_data_flagA2, posedge DA[17],1.000, 0.500, NOT_DA17);
      $setuphold(posedge CLKA &&& re_data_flagA2, negedge DA[17],1.000, 0.500, NOT_DA17);
      $setuphold(posedge CLKA &&& re_data_flagA2, posedge DA[18],1.000, 0.500, NOT_DA18);
      $setuphold(posedge CLKA &&& re_data_flagA2, negedge DA[18],1.000, 0.500, NOT_DA18);
      $setuphold(posedge CLKA &&& re_data_flagA2, posedge DA[19],1.000, 0.500, NOT_DA19);
      $setuphold(posedge CLKA &&& re_data_flagA2, negedge DA[19],1.000, 0.500, NOT_DA19);
      $setuphold(posedge CLKA &&& re_data_flagA2, posedge DA[20],1.000, 0.500, NOT_DA20);
      $setuphold(posedge CLKA &&& re_data_flagA2, negedge DA[20],1.000, 0.500, NOT_DA20);
      $setuphold(posedge CLKA &&& re_data_flagA2, posedge DA[21],1.000, 0.500, NOT_DA21);
      $setuphold(posedge CLKA &&& re_data_flagA2, negedge DA[21],1.000, 0.500, NOT_DA21);
      $setuphold(posedge CLKA &&& re_data_flagA2, posedge DA[22],1.000, 0.500, NOT_DA22);
      $setuphold(posedge CLKA &&& re_data_flagA2, negedge DA[22],1.000, 0.500, NOT_DA22);
      $setuphold(posedge CLKA &&& re_data_flagA2, posedge DA[23],1.000, 0.500, NOT_DA23);
      $setuphold(posedge CLKA &&& re_data_flagA2, negedge DA[23],1.000, 0.500, NOT_DA23);
      $setuphold(posedge CLKA &&& re_data_flagA3, posedge DA[24],1.000, 0.500, NOT_DA24);
      $setuphold(posedge CLKA &&& re_data_flagA3, negedge DA[24],1.000, 0.500, NOT_DA24);
      $setuphold(posedge CLKA &&& re_data_flagA3, posedge DA[25],1.000, 0.500, NOT_DA25);
      $setuphold(posedge CLKA &&& re_data_flagA3, negedge DA[25],1.000, 0.500, NOT_DA25);
      $setuphold(posedge CLKA &&& re_data_flagA3, posedge DA[26],1.000, 0.500, NOT_DA26);
      $setuphold(posedge CLKA &&& re_data_flagA3, negedge DA[26],1.000, 0.500, NOT_DA26);
      $setuphold(posedge CLKA &&& re_data_flagA3, posedge DA[27],1.000, 0.500, NOT_DA27);
      $setuphold(posedge CLKA &&& re_data_flagA3, negedge DA[27],1.000, 0.500, NOT_DA27);
      $setuphold(posedge CLKA &&& re_data_flagA3, posedge DA[28],1.000, 0.500, NOT_DA28);
      $setuphold(posedge CLKA &&& re_data_flagA3, negedge DA[28],1.000, 0.500, NOT_DA28);
      $setuphold(posedge CLKA &&& re_data_flagA3, posedge DA[29],1.000, 0.500, NOT_DA29);
      $setuphold(posedge CLKA &&& re_data_flagA3, negedge DA[29],1.000, 0.500, NOT_DA29);
      $setuphold(posedge CLKA &&& re_data_flagA3, posedge DA[30],1.000, 0.500, NOT_DA30);
      $setuphold(posedge CLKA &&& re_data_flagA3, negedge DA[30],1.000, 0.500, NOT_DA30);
      $setuphold(posedge CLKA &&& re_data_flagA3, posedge DA[31],1.000, 0.500, NOT_DA31);
      $setuphold(posedge CLKA &&& re_data_flagA3, negedge DA[31],1.000, 0.500, NOT_DA31);
      $setuphold(posedge CLKB, posedge CENB, 1.000, 0.500, NOT_CENB);
      $setuphold(posedge CLKB, negedge CENB, 1.000, 0.500, NOT_CENB);
      $setuphold(posedge CLKB &&& re_flagB, posedge WENB[0], 1.000, 0.500, NOT_WENB0);
      $setuphold(posedge CLKB &&& re_flagB, negedge WENB[0], 1.000, 0.500, NOT_WENB0);
      $setuphold(posedge CLKB &&& re_flagB, posedge WENB[1], 1.000, 0.500, NOT_WENB1);
      $setuphold(posedge CLKB &&& re_flagB, negedge WENB[1], 1.000, 0.500, NOT_WENB1);
      $setuphold(posedge CLKB &&& re_flagB, posedge WENB[2], 1.000, 0.500, NOT_WENB2);
      $setuphold(posedge CLKB &&& re_flagB, negedge WENB[2], 1.000, 0.500, NOT_WENB2);
      $setuphold(posedge CLKB &&& re_flagB, posedge WENB[3], 1.000, 0.500, NOT_WENB3);
      $setuphold(posedge CLKB &&& re_flagB, negedge WENB[3], 1.000, 0.500, NOT_WENB3);
      ...
      $setuphold(posedge CLKB &&& re_data_flagB0, posedge DB[0],1.000, 0.500, NOT_DB0);
      $setuphold(posedge CLKB &&& re_data_flagB0, negedge DB[0],1.000, 0.500, NOT_DB0);
      $setuphold(posedge CLKB &&& re_data_flagB0, posedge DB[1],1.000, 0.500, NOT_DB1);
      $setuphold(posedge CLKB &&& re_data_flagB0, negedge DB[1],1.000, 0.500, NOT_DB1);
      $setuphold(posedge CLKB &&& re_data_flagB0, posedge DB[2],1.000, 0.500, NOT_DB2);
      $setuphold(posedge CLKB &&& re_data_flagB0, negedge DB[2],1.000, 0.500, NOT_DB2);
      $setuphold(posedge CLKB &&& re_data_flagB0, posedge DB[3],1.000, 0.500, NOT_DB3);
      $setuphold(posedge CLKB &&& re_data_flagB0, negedge DB[3],1.000, 0.500, NOT_DB3);
      $setuphold(posedge CLKB &&& re_data_flagB0, posedge DB[4],1.000, 0.500, NOT_DB4);
      $setuphold(posedge CLKB &&& re_data_flagB0, negedge DB[4],1.000, 0.500, NOT_DB4);
      $setuphold(posedge CLKB &&& re_data_flagB0, posedge DB[5],1.000, 0.500, NOT_DB5);
      $setuphold(posedge CLKB &&& re_data_flagB0, negedge DB[5],1.000, 0.500, NOT_DB5);
      $setuphold(posedge CLKB &&& re_data_flagB0, posedge DB[6],1.000, 0.500, NOT_DB6);
      $setuphold(posedge CLKB &&& re_data_flagB0, negedge DB[6],1.000, 0.500, NOT_DB6);
      $setuphold(posedge CLKB &&& re_data_flagB0, posedge DB[7],1.000, 0.500, NOT_DB7);
      $setuphold(posedge CLKB &&& re_data_flagB0, negedge DB[7],1.000, 0.500, NOT_DB7);
      $setuphold(posedge CLKB &&& re_data_flagB1, posedge DB[8],1.000, 0.500, NOT_DB8);
      $setuphold(posedge CLKB &&& re_data_flagB1, negedge DB[8],1.000, 0.500, NOT_DB8);
      $setuphold(posedge CLKB &&& re_data_flagB1, posedge DB[9],1.000, 0.500, NOT_DB9);
      $setuphold(posedge CLKB &&& re_data_flagB1, negedge DB[9],1.000, 0.500, NOT_DB9);
      $setuphold(posedge CLKB &&& re_data_flagB1, posedge DB[10],1.000, 0.500, NOT_DB10);
      $setuphold(posedge CLKB &&& re_data_flagB1, negedge DB[10],1.000, 0.500, NOT_DB10);
      $setuphold(posedge CLKB &&& re_data_flagB1, posedge DB[11],1.000, 0.500, NOT_DB11);
      $setuphold(posedge CLKB &&& re_data_flagB1, negedge DB[11],1.000, 0.500, NOT_DB11);
      $setuphold(posedge CLKB &&& re_data_flagB1, posedge DB[12],1.000, 0.500, NOT_DB12);
      $setuphold(posedge CLKB &&& re_data_flagB1, negedge DB[12],1.000, 0.500, NOT_DB12);
      $setuphold(posedge CLKB &&& re_data_flagB1, posedge DB[13],1.000, 0.500, NOT_DB13);
      $setuphold(posedge CLKB &&& re_data_flagB1, negedge DB[13],1.000, 0.500, NOT_DB13);
      $setuphold(posedge CLKB &&& re_data_flagB1, posedge DB[14],1.000, 0.500, NOT_DB14);
      $setuphold(posedge CLKB &&& re_data_flagB1, negedge DB[14],1.000, 0.500, NOT_DB14);
      $setuphold(posedge CLKB &&& re_data_flagB1, posedge DB[15],1.000, 0.500, NOT_DB15);
      $setuphold(posedge CLKB &&& re_data_flagB1, negedge DB[15],1.000, 0.500, NOT_DB15);
      $setuphold(posedge CLKB &&& re_data_flagB2, posedge DB[16],1.000, 0.500, NOT_DB16);
      $setuphold(posedge CLKB &&& re_data_flagB2, negedge DB[16],1.000, 0.500, NOT_DB16);
      $setuphold(posedge CLKB &&& re_data_flagB2, posedge DB[17],1.000, 0.500, NOT_DB17);
      $setuphold(posedge CLKB &&& re_data_flagB2, negedge DB[17],1.000, 0.500, NOT_DB17);
      $setuphold(posedge CLKB &&& re_data_flagB2, posedge DB[18],1.000, 0.500, NOT_DB18);
      $setuphold(posedge CLKB &&& re_data_flagB2, negedge DB[18],1.000, 0.500, NOT_DB18);
      $setuphold(posedge CLKB &&& re_data_flagB2, posedge DB[19],1.000, 0.500, NOT_DB19);
      $setuphold(posedge CLKB &&& re_data_flagB2, negedge DB[19],1.000, 0.500, NOT_DB19);
      $setuphold(posedge CLKB &&& re_data_flagB2, posedge DB[20],1.000, 0.500, NOT_DB20);
      $setuphold(posedge CLKB &&& re_data_flagB2, negedge DB[20],1.000, 0.500, NOT_DB20);
      $setuphold(posedge CLKB &&& re_data_flagB2, posedge DB[21],1.000, 0.500, NOT_DB21);
      $setuphold(posedge CLKB &&& re_data_flagB2, negedge DB[21],1.000, 0.500, NOT_DB21);
      $setuphold(posedge CLKB &&& re_data_flagB2, posedge DB[22],1.000, 0.500, NOT_DB22);
      $setuphold(posedge CLKB &&& re_data_flagB2, negedge DB[22],1.000, 0.500, NOT_DB22);
      $setuphold(posedge CLKB &&& re_data_flagB2, posedge DB[23],1.000, 0.500, NOT_DB23);
      $setuphold(posedge CLKB &&& re_data_flagB2, negedge DB[23],1.000, 0.500, NOT_DB23);
      $setuphold(posedge CLKB &&& re_data_flagB3, posedge DB[24],1.000, 0.500, NOT_DB24);
      $setuphold(posedge CLKB &&& re_data_flagB3, negedge DB[24],1.000, 0.500, NOT_DB24);
      $setuphold(posedge CLKB &&& re_data_flagB3, posedge DB[25],1.000, 0.500, NOT_DB25);
      $setuphold(posedge CLKB &&& re_data_flagB3, negedge DB[25],1.000, 0.500, NOT_DB25);
      $setuphold(posedge CLKB &&& re_data_flagB3, posedge DB[26],1.000, 0.500, NOT_DB26);
      $setuphold(posedge CLKB &&& re_data_flagB3, negedge DB[26],1.000, 0.500, NOT_DB26);
      $setuphold(posedge CLKB &&& re_data_flagB3, posedge DB[27],1.000, 0.500, NOT_DB27);
      $setuphold(posedge CLKB &&& re_data_flagB3, negedge DB[27],1.000, 0.500, NOT_DB27);
      $setuphold(posedge CLKB &&& re_data_flagB3, posedge DB[28],1.000, 0.500, NOT_DB28);
      $setuphold(posedge CLKB &&& re_data_flagB3, negedge DB[28],1.000, 0.500, NOT_DB28);
      $setuphold(posedge CLKB &&& re_data_flagB3, posedge DB[29],1.000, 0.500, NOT_DB29);
      $setuphold(posedge CLKB &&& re_data_flagB3, negedge DB[29],1.000, 0.500, NOT_DB29);
      $setuphold(posedge CLKB &&& re_data_flagB3, posedge DB[30],1.000, 0.500, NOT_DB30);
      $setuphold(posedge CLKB &&& re_data_flagB3, negedge DB[30],1.000, 0.500, NOT_DB30);
      $setuphold(posedge CLKB &&& re_data_flagB3, posedge DB[31],1.000, 0.500, NOT_DB31);
      $setuphold(posedge CLKB &&& re_data_flagB3, negedge DB[31],1.000, 0.500, NOT_DB31);
